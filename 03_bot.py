...
client = OpenAI(
  api_key="<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>",
)
...
while True:
    ...
    pyautogui.dragTo(1862 , 914 , duration=2.0, button='left')  # Drag for 1 second
